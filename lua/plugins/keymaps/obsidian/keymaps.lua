...
vim.keymap.set("n", "<leader>os", ":Telescope find_files search_dirs={\""..functions.vault_path.."\"}<cr>")
vim.keymap.set("n", "<leader>of", ":Telescope live_grep search_dirs={\""..functions.vault_path.."\"}<cr>")
